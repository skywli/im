...
int main(int argc, char *argv[]) {
    ...
    if(access("../log/dispatch",F_OK)==-1){
       mkdir("../log/dispatch", 0766);
    }

    setenv("project_dir","../log/dispatch/",1);
	ConfigFileReader::getInstance()->init(CONF_DISPATCH_URL);
